...
def mlog(fnc="none", msg=""):
    print msg
    master_log(pkg="dash_server_fastMPC.py", fnc=fnc, msg=msg)
...
def make_request_handler(input_dict):
    ...
    class Request_Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            content = "MPC Server: {}".format(input_dict['log_file_path'])
...
def run(server_class=HTTPServer, port=8666, log_file_path=LOG_FILE):
