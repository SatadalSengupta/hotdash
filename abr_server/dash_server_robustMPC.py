...
def mlog(fnc="none", msg=""):
    print msg
    master_log(pkg="dash_server_robustMPC.py", fnc=fnc, msg=msg)
...
def make_request_handler(input_dict):
    ...
    class Request_Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            content = "Robust MPC Server: {}".format(input_dict['log_file_path'])
...
def run(server_class=HTTPServer, port=8777, log_file_path=LOG_FILE):
    ...
    with open(log_file_path, 'wb') as log_file:
        ...
        mlog("Listening on port {}".format(port))
        httpd.serve_forever()
