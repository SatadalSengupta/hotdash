...
def mlog(fnc="none", msg=""):
    print msg
    master_log(pkg="dash_server_RB.py", fnc=fnc, msg=msg)
...
def make_request_handler(input_dict):
    ...
    class Request_Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            content = "Rate Based Server: {}".format(input_dict['log_file_path'])
...
def run(server_class=HTTPServer, port=8444, log_file_path=LOG_FILE):
