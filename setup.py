...
os.system("sudo cp video_server/dash.all.debug.js /var/www/html")
...
print "Need to put trace files in 'cooked_traces'."
print "Need to put pre-trained NN model in 'rl_server/results'."
